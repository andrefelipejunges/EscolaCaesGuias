...
<body>
  <header>
    <nav class="navbar fixed-top navbar-light bg-light" style ="background-color:#F8F8FF;">
        <a class="navbar-brand" href="index.php"><img src="../../../assets/img/Logo_Escola_Caes_Guias_Keller.png" class ="logo"> </a>
    </nav>
  </header>
    ...
    <form method="post">
      ...
      <nav>
        <ul class="menu">
          <li><a href=http://localhost/EscolaCaesGuias/app/views/Esqueleto/index.php>Home</a></li>
          <li><a href=http://localhost/EscolaCaesGuias/app/views/Login/LoginView.php>Login</a></li>
